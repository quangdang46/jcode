...
pub fn ai_text() -> ftui_style::Style {
    ftui_style::Style::default()
}
pub fn blend_color(_c1: Color, _c2: Color, _t: f32) -> Color {
    rgb(128, 128, 128)
}
...
pub fn prompt_entry_bg_color() -> Color {
    rgb(30, 30, 30)
}
pub fn prompt_entry_color() -> Color {
    rgb(200, 200, 200)
}
pub fn prompt_entry_shimmer_color() -> Color {
    rgb(100, 100, 100)
}
...
pub fn activity_indicator_frame_index(_t: f64, _speed: f64) -> usize {
    0
}
pub fn animated_tool_color(_i: usize) -> Color {
    rgb(128, 128, 128)
}
